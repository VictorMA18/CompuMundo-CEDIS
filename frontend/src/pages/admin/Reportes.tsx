...
export default function Reportes() {
  ...
  const downloadReport = async (
    ...
    try {
      ...
      const url = `/api/reportes/${tipo}/${formato}${queryString}`;
    ...
    <div className="table-card" style={{ padding: '1.5rem' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <span style={{ fontSize: '0.9rem', color: '#666' }}>📅 Filtrar por fecha:</span>
          <input 
            type="date" 
            className="input" 
          ...
          {(fechaInicio || fechaFin) && (
            <button 
              ...
              style={{ height: '35px', padding: '0 10px', fontSize: '0.85rem' }} 
      ...
      <div style={{ 
        ...
        <div className="card-report" style={cardStyle}>
            <div style={{ flex: 1 }}>
              ...
              <p style={descStyle}>
                Estudiantes y docentes con préstamos vencidos pendientes de devolución.
              </p>
            </div>
            <div style={btnContainerStyle}>
                <button className="btn" style={btnExcelStyle} onClick={() => downloadReport('morosos', 'excel')}>
                    📗 Excel
                </button>
                <button className="btn" style={btnPdfStyle} onClick={() => downloadReport('morosos', 'pdf')}>
                    📕 PDF
                </button>
            </div>
        </div>
        ...
        <div className="card-report" style={cardStyle}>
            <div style={{ flex: 1 }}>
              ...
              <p style={descStyle}>
                Inventario de material que se encuentra actualmente fuera de la biblioteca.
              </p>
            </div>
            <div style={btnContainerStyle}>
                <button className="btn" style={btnExcelStyle} onClick={() => downloadReport('pendientes', 'excel')}>
                    📗 Excel
                </button>
                <button className="btn" style={btnPdfStyle} onClick={() => downloadReport('pendientes', 'pdf')}>
                    📕 PDF
                </button>
            </div>
        </div>
        ...
        <div className="card-report" style={cardStyle}>
            ...
            <div style={btnContainerStyle}>
                <button className="btn" style={btnExcelStyle} onClick={() => downloadReport('lectores-por-documento', 'excel')}>
                    📗 Excel
                </button>
                <button className="btn" style={btnPdfStyle} onClick={() => downloadReport('lectores-por-documento', 'pdf')}>
                    📕 PDF
                </button>
            </div>
        </div>
...
const cardStyle: React.CSSProperties = {
  backgroundColor: '#f8f9fa', // GRIS CLARO PARA CONTRASTE
